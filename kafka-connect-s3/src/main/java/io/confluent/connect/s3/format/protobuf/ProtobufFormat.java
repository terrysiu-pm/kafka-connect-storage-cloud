...
public class ProtobufFormat implements Format<S3SinkConnectorConfig, String> {
  private final S3Storage storage;
  private final ByteArrayConverter converter;

  public ProtobufFormat(S3Storage storage) {
  ...
  public RecordWriterProvider<S3SinkConnectorConfig> getRecordWriterProvider() {
    return new ProtobufRecordWriterProvider(storage, converter);
  }
