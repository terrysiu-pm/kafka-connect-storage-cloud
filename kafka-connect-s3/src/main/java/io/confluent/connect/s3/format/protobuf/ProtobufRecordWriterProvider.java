...
package io.confluent.connect.s3.format.protobuf;
...
public class ProtobufRecordWriterProvider extends RecordViewSetter
    implements RecordWriterProvider<S3SinkConnectorConfig> {

  private static final Logger log = LoggerFactory.getLogger(ProtobufRecordWriterProvider.class);
  private final S3Storage storage;
  private final ByteArrayConverter converter;
  private final String extension;
  private final byte[] lineSeparatorBytes;

  ProtobufRecordWriterProvider(S3Storage storage, ByteArrayConverter converter) {
    ...
    return new S3RetriableRecordWriter(
      new IORecordWriter() {
        ...
        public void write(SinkRecord record) throws IOException {
          ...
          s3outWrapper.write(lengthBytes);
